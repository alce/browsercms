...
class FileBlockTest < ActiveSupport::TestCase
  def setup
    ...
    @file_block = Factory.build(:file_block,
                                :attachments_attributes => {
                                  "0" => {
                                    :attachment_name => 'file',
                                    :data => @uploaded_file,
                                    :section_id => root_section.id,
                                    :data_file_path => "/test.jpg"}},
  ...
  #   @file_block.save!
  #   attachment = @file_block.file
  #   raise @file_block.versions[0].inspect
  ...
  def test_attachment_is_required
    raise @file_block.inspect
    @file_block[:attachments_attributes]["0"][:data] = nil
